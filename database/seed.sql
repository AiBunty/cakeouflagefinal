...
CREATE TEMPORARY TABLE seed_plan (
  ...
  dietary_type ENUM('veg','nonveg') NOT NULL DEFAULT 'veg',
...
INSERT INTO seed_plan (leaf_slug, item_count, title_prefix, slug_prefix, dietary_type, dietary_tag, occasion_tag, is_b2b_enabled) VALUES
('classic-chocolate', 12, 'Belgian Velvet Hazelnut Gateau', 'belgian-velvet-hazelnut-gateau', 'veg', 'regular', NULL, 0),
('classic-non-chocolate', 10, 'Madagascar Vanilla Bloom Cake', 'madagascar-vanilla-bloom-cake', 'veg', 'eggless', NULL, 0),
('cheesecakes-chocolate', 8, 'Cocoa Silk Cheesecake', 'cocoa-silk-cheesecake', 'veg', 'regular', NULL, 0),
('cheesecakes-non-chocolate', 8, 'Berry Cloud Cheesecake', 'berry-cloud-cheesecake', 'veg', 'eggless', NULL, 0),
('opera-cakes', 4, 'Opera Noir Layer Cake', 'opera-noir-layer-cake', 'veg', 'regular', NULL, 0),
('mousse-cakes', 6, 'Mousse Eclipse Cake', 'mousse-eclipse-cake', 'veg', 'regular', NULL, 0),
('tiramisu', 4, 'Mascarpone Tiramisu Indulgence', 'mascarpone-tiramisu-indulgence', 'veg', 'regular', NULL, 0),
('tart-cakes', 6, 'Citrus Cacao Tart Cake', 'citrus-cacao-tart-cake', 'veg', 'regular', NULL, 0),
('tea-cakes-chocolate', 5, 'Chocolate Travel Loaf Luxe', 'chocolate-travel-loaf-luxe', 'veg', 'regular', NULL, 0),
('tea-cakes-non-chocolate', 5, 'Honey Almond Travel Loaf', 'honey-almond-travel-loaf', 'veg', 'eggless', NULL, 0),
('mini-cake-platters', 6, 'Mini Celebration Platter', 'mini-celebration-platter', 'veg', 'regular', NULL, 0),
('liquor-cakes', 5, 'Reserve Barrel Infusion Cake', 'reserve-barrel-infusion-cake', 'veg', 'regular', NULL, 0),

('birthday-florals-chocolate', 3, 'Floral Cocoa Birthday Cake', 'floral-cocoa-birthday-cake', 'veg', 'regular', 'birthday', 0),
('birthday-florals-non-chocolate', 3, 'Floral Vanilla Birthday Cake', 'floral-vanilla-birthday-cake', 'veg', 'eggless', 'birthday', 0),
('birthday-non-floral-chocolate', 3, 'Modern Cocoa Birthday Cake', 'modern-cocoa-birthday-cake', 'veg', 'regular', 'birthday', 0),
('birthday-non-floral-non-chocolate', 3, 'Modern Vanilla Birthday Cake', 'modern-vanilla-birthday-cake', 'veg', 'eggless', 'birthday', 0),
('birthday-themed-kids', 3, 'Kids Theme Party Cake', 'kids-theme-party-cake', 'veg', 'regular', 'birthday', 0),
('birthday-themed-adults', 3, 'Adult Theme Signature Cake', 'adult-theme-signature-cake', 'veg', 'regular', 'birthday', 0),
('birthday-half-birthday', 3, 'Half Birthday Petite Cake', 'half-birthday-petite-cake', 'veg', 'regular', 'birthday', 0),
('birthday-dual-triple', 3, 'Dual Triple Flavor Cake', 'dual-triple-flavor-cake', 'veg', 'regular', 'birthday', 0),
('birthday-top-forward', 3, 'Top Forward Accent Cake', 'top-forward-accent-cake', 'veg', 'regular', 'birthday', 0),
('birthday-rotating-tier', 3, 'Rotating Tier Luxe Cake', 'rotating-tier-luxe-cake', 'veg', 'regular', 'birthday', 0),

('anniversary-floral-chocolate', 3, 'Anniversary Floral Cocoa Cake', 'anniversary-floral-cocoa-cake', 'veg', 'regular', 'anniversary', 0),
('anniversary-floral-non-chocolate', 3, 'Anniversary Floral Vanilla Cake', 'anniversary-floral-vanilla-cake', 'veg', 'eggless', 'anniversary', 0),
('anniversary-non-floral-chocolate', 3, 'Anniversary Cocoa Minimal Cake', 'anniversary-cocoa-minimal-cake', 'veg', 'regular', 'anniversary', 0),
('anniversary-non-floral-non-chocolate', 3, 'Anniversary Vanilla Minimal Cake', 'anniversary-vanilla-minimal-cake', 'veg', 'eggless', 'anniversary', 0),

('baby-shower-cakes', 10, 'Moonbeam Baby Shower Cake', 'moonbeam-baby-shower-cake', 'veg', 'regular', 'baby_shower', 0),

('wedding-chandelier-cakes', 3, 'Chandelier Wedding Luxe Cake', 'chandelier-wedding-luxe-cake', 'veg', 'regular', 'wedding', 0),
('wedding-grand-cakes', 3, 'Grand Wedding Statement Cake', 'grand-wedding-statement-cake', 'veg', 'regular', 'wedding', 0),
('wedding-acrylic-tier-spacer', 3, 'Acrylic Spacer Tier Cake', 'acrylic-spacer-tier-cake', 'veg', 'regular', 'wedding', 0),
('wedding-classic-tiered', 3, 'Classic Tier Wedding Cake', 'classic-tier-wedding-cake', 'veg', 'regular', 'wedding', 0),
('wedding-deconstructed-tiered', 3, 'Deconstructed Tier Wedding Cake', 'deconstructed-tier-wedding-cake', 'veg', 'regular', 'wedding', 0),

('pinatas', 5, 'Pinata Surprise Smash Cake', 'pinata-surprise-smash-cake', 'veg', 'regular', 'themed', 0),
('cake-smash-cakes', 5, 'Cake Smash Portrait Cake', 'cake-smash-portrait-cake', 'veg', 'regular', 'themed', 0),
('bride-to-be-groom-to-be', 4, 'Bride Groom Party Cake', 'bride-groom-party-cake', 'veg', 'regular', 'wedding', 0),
('congratulatory-graduation-cakes', 4, 'Graduation Glory Cake', 'graduation-glory-cake', 'veg', 'regular', 'graduation', 0),
('trending', 6, 'Trending Artisan Cake', 'trending-artisan-cake', 'veg', 'regular', NULL, 0),
('graphic-cakes', 6, 'Graphic Statement Cake', 'graphic-statement-cake', 'veg', 'regular', NULL, 0),

('brownies', 6, 'Cocoa Fudge Brownie Box', 'cocoa-fudge-brownie-box', 'veg', 'vegan', NULL, 0),
('cookies', 6, 'Buttercrisp Cookie Jar', 'buttercrisp-cookie-jar', 'veg', 'regular', NULL, 0),
('chocolates', 6, 'Artisan Chocolate Collection', 'artisan-chocolate-collection', 'veg', 'regular', NULL, 0),
('mini-tarts', 5, 'Mini Tart Indulgence Box', 'mini-tart-indulgence-box', 'veg', 'regular', NULL, 0),
('dessert-tubs', 5, 'Dessert Tub Delight', 'dessert-tub-delight', 'veg', 'eggless', NULL, 0),

('hampers', 6, 'Mini Dessert Indulgence Hamper', 'mini-dessert-indulgence-hamper', 'veg', 'regular', 'gifting', 1),
('platters', 4, 'Celebration Dessert Platter', 'celebration-dessert-platter', 'veg', 'regular', 'gifting', 1),
('festive-gifting', 4, 'Festive Luxe Gifting Box', 'festive-luxe-gifting-box', 'veg', 'regular', 'gifting', 1),
('corporate-gifting', 4, 'Corporate Signature Gifting Box', 'corporate-signature-gifting-box', 'veg', 'regular', 'gifting', 1),

('beginner-workshops', 2, 'Workshop Seat Package', 'workshop-seat-package', 'veg', 'regular', 'course', 0),
('eggless-baking', 2, 'Eggless Masterclass Seat', 'eggless-masterclass-seat', 'veg', 'regular', 'course', 0),
('festive-workshops', 2, 'Festive Workshop Seat', 'festive-workshop-seat', 'veg', 'regular', 'course', 0),
('professional-basics', 2, 'Professional Basics Seat', 'professional-basics-seat', 'veg', 'regular', 'course', 0),

('corporate-orders', 3, 'Corporate Bulk Cake Pack', 'corporate-bulk-cake-pack', 'veg', 'regular', 'b2b', 1),
('reseller-cake-shop-owners', 3, 'Reseller Stock Cake Pack', 'reseller-stock-cake-pack', 'veg', 'regular', 'b2b', 1),
('bulk-dessert-orders', 3, 'Bulk Dessert Service Pack', 'bulk-dessert-service-pack', 'veg', 'regular', 'b2b', 1),
('event-orders', 3, 'Event Dessert Table Pack', 'event-dessert-table-pack', 'veg', 'regular', 'b2b', 1),
('request-quote', 2, 'Custom Quote Product Set', 'custom-quote-product-set', 'veg', 'regular', 'b2b', 1);
...
INSERT INTO products (
  ...
  occasion_tag, dietary_type, dietary_tag, availability_status, lead_time_hours, customisation_note,
