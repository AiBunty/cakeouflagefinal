        ...
        <section class="crm-settings-card">
            ...
            <div class="crm-settings-form">
                <div class="crm-helper-list">
                    ...
                    <div class="crm-helper-chip"><strong>contact.description</strong><span>Quote / inquiry description summary</span></div>
                    <div class="crm-helper-chip"><strong>contact.quote_description</strong><span>Detailed Build Your Cake requirement brief</span></div>
                    <div class="crm-helper-chip"><strong>contact.upi_link</strong><span>Payment link or UPI link</span></div>
                </div>
                <p class="crm-inline-note">Required payload values for CRM trigger governance: <strong>order id</strong>, <strong>amount</strong>, <strong>name</strong>, <strong>mobile</strong>, <strong>email</strong>, and <strong>quote description</strong>. Recommended CRM trigger keys: <strong>follow_up_review</strong> for recurring quarterly follow-ups and <strong>annual_reorder</strong> for yearly pre-celebration reminders.</p>
            </div>
        </section>
    </div>
</div>
