...
$sql = "
    SELECT
      ...
      MAX(o.fulfilment_mode) AS fulfilment_mode,
      MAX(o.order_mode) AS order_mode,
      MAX(o.order_status) AS order_status,
      MAX(o.production_status) AS production_status,
      MAX(o.requires_kitchen_production) AS requires_kitchen_production,
      MAX(o.slot_id) AS slot_id,
      MAX(o.scheduled_slot_label) AS scheduled_slot_label,
      MAX(o.grand_total) AS grand_total,
      MAX(o.advance_amount) AS advance_amount,
      MAX(o.admin_note) AS admin_note,
