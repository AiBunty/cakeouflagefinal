...
try {
    ...
    $result = $service->applyAction([
        ...
        'settlement_reference' => trim((string)($_POST['settlement_reference'] ?? '')),
        'settlement_payment_method' => trim((string)($_POST['settlement_payment_method'] ?? '')),
        'settled_amount' => (float)($_POST['settled_amount'] ?? 0),
