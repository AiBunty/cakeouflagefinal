...
$_navIcons = [
    ...
    'coupons.php'            => '<svg viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/></svg>',
...
$_navSections = [
    'Sales'    => ['dashboard.php', 'orders.php', 'bank-alerts.php', 'manual_order.php', 'production_plan.php'],
    'Catalog'  => ['products.php', 'categories.php', 'banners.php', 'coupons.php', 'import-products.php'],
    'CRM'      => ['follow_ups.php', 'build-your-own-cake.php', 'crm_settings.php', 'communications.php', 'crm_push_logs.php'],
    'Reports'  => ['sales_register.php', 'sales_report.php', 'cash_report.php', 'bank_report.php', 'collection_report.php', 'crm_report.php', 'coupon_report.php', 'celebration_report.php'],
