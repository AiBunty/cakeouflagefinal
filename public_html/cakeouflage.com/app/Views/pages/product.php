...
$waMsg          = rawurlencode("Hi! I'd like to order: " . $product['name'] . ". Please share availability and pricing.");
$waLink         = "https://wa.me/91" . ltrim($product['whatsapp_number'] ?? '9673565935', '+') . "?text={$waMsg}";
?>
...
<?php endforeach; ?>
        ...
        <div class="pdp__info">
          ...
          <div class="pdp__header">
            <h1 class="pdp__title"><?= htmlspecialchars($product['name'], ENT_QUOTES, 'UTF-8') ?></h1>
