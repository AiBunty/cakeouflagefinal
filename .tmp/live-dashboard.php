...
<div class="dash-shell">
  ...
  <div class="dash-grid">
    <a class="dash-card" href="revenue_report.php?status_scope=pending_orders&period=month">
      <strong>Pending Orders</strong>
      <div class="value"><?= $pendingOrders ?></div>
      <div class="meta">Click for pending order detail report</div>
    </a>

    <a class="dash-card" href="revenue_report.php?status_scope=paid_only&period=day">
    ...
    <a class="dash-card" href="revenue_report.php?status_scope=paid_only&period=month">
    ...
    <a class="dash-card" href="revenue_report.php?status_scope=paid_only&period=year">
  ...
  <div class="dash-summary">
    <section class="dash-panel">
      ...
      <div class="dash-links">
        <a class="dash-link" href="revenue_report.php?status_scope=pending_orders">Pending Orders</a>
        <a class="dash-link" href="revenue_report.php?status_scope=completed_orders">Completed Orders</a>
        <a class="dash-link" href="revenue_report.php?status_scope=payment_pending">Payment Pending</a>
        <a class="dash-link" href="revenue_report.php?status_scope=rejected_orders">Rejected Orders</a>
      </div>
      <div class="scope-exports">
        ...
        <div class="scope-row">
          ...
          <a class="scope-export-btn" href="revenue_report.php?status_scope=pending_orders&export=csv">CSV</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=pending_orders&export=excel">Excel</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=pending_orders&export=pdf">PDF</a>
        </div>
        <div class="scope-row">
          <div class="scope-name">Completed Orders</div>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=completed_orders&export=csv">CSV</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=completed_orders&export=excel">Excel</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=completed_orders&export=pdf">PDF</a>
        </div>
        <div class="scope-row">
          <div class="scope-name">Payment Pending</div>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=payment_pending&export=csv">CSV</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=payment_pending&export=excel">Excel</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=payment_pending&export=pdf">PDF</a>
        </div>
        <div class="scope-row">
          <div class="scope-name">Rejected Orders</div>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=rejected_orders&export=csv">CSV</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=rejected_orders&export=excel">Excel</a>
          <a class="scope-export-btn" href="revenue_report.php?status_scope=rejected_orders&export=pdf">PDF</a>
        </div>
      </div>
    ...
    <section class="dash-panel">
      ...
      <div class="dash-links">
        ...
        <a class="dash-link" href="revenue_report.php?status_scope=paid_only">Revenue Reports</a>
        <a class="dash-link" href="revenue_report.php?status_scope=paid_only&export=csv">Quick CSV</a>
      </div>
