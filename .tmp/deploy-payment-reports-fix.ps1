...
$files=@('admin/update_order_status.php','admin/update_order.php','admin/order_invoice.php','admin/revenue_report.php')
$targets=@("ftp://$hostName/","ftp://$hostName/public_html/cakeouflage.com/")
foreach($f in $files){
