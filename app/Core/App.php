...
final class App
{
    ...
    public function __construct()
    {
        ...
        $this->routes = [
            ...
            ['method' => 'POST', 'path' => '/api/auth/check-user', 'handler' => [$api, 'authCheckUser']],
            ...
            ['method' => 'POST', 'path' => '/api/admin/import/products/preview', 'handler' => [$adminApi, 'bulkImportProductsPreview']],
            ...
            ['method' => 'GET', 'path' => '/api/admin/import/versions', 'handler' => [$adminApi, 'importVersionsList']],
            ['method' => 'POST', 'path' => '/api/admin/import/versions/:versionId/restore', 'handler' => [$adminApi, 'importVersionRestore']],
            ['method' => 'GET', 'path' => '/api/admin/product-size-master', 'handler' => [$adminApi, 'productSizeMasterList']],
            ['method' => 'POST', 'path' => '/api/admin/product-size-master', 'handler' => [$adminApi, 'productSizeMasterCreate']],
            ['method' => 'PATCH', 'path' => '/api/admin/product-size-master/:sizeId', 'handler' => [$adminApi, 'productSizeMasterUpdate']],
            ['method' => 'POST', 'path' => '/api/admin/product-size-master/reorder', 'handler' => [$adminApi, 'productSizeMasterReorder']],
