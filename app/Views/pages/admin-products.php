  ...
  <div class="admin-panel-grid">
    <article class="card">
      ...
      <form id="adminProductForm" class="form-grid" novalidate>
        ...
        <div class="form-row-two">
          <label class="form-control"><span>Dietary Tag</span><select name="dietary_tag"><option value="regular">Regular</option><option value="eggless">Eggless</option><option value="vegan">Vegan</option><option value="sugar_free">Sugar Free</option><option value="gluten_free">Gluten Free</option></select></label>
          <label class="form-control">
            <span>Veg / Non-Veg</span>
            <span class="radio-group">
              <label><input type="radio" name="is_veg" value="1" checked /> <span class="veg-dot veg-dot--veg"></span> Veg</label>
              <label><input type="radio" name="is_veg" value="0" /> <span class="veg-dot veg-dot--nonveg"></span> Non-Veg</label>
            </span>
          </label>
        </div>
