<section class="section section--compact" data-page="admin-bulk-import">
  ...
  <div class="admin-page-header">
    <div>
      ...
      <p class="admin-page-desc">Upload a CSV or Excel (.xlsx) to create or update products in bulk. Supports dry-run and strict variant enforcement.</p>
    </div>
    <div class="admin-page-actions">
      <a href="/api/admin/import/template" class="btn btn--outline-burgundy">Download Sample Excel</a>
    </div>
  </div>
  ...
  <div class="admin-panel-grid admin-panel-grid--two">
    <article class="card">
      ...
      <p class="text-muted">Upload product rows in CSV or Excel (.xlsx) format. Existing SKUs are updated and reported as duplicates.</p>
      <div class="product-card__actions">
        <a class="btn btn--secondary" href="/api/admin/import/template">Download Sample Excel</a>
      </div>

      <form id="bulkImportForm" class="form-grid" enctype="multipart/form-data">
        <label class="form-control">
          <span>CSV or Excel (.xlsx) File</span>
          <input type="file" id="bulkImportFile" name="file" accept=".csv,.xlsx,text/csv" required />
        </label>
